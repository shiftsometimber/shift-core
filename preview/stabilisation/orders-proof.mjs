...
const evidenceDir='work/staging/generated/review-evidence';mkdirSync(evidenceDir,{recursive:true});
...
try{
 ...
 await page.screenshot({path:evidenceDir+'/orders-signed-out-phone.png',fullPage:true});
 ...
 await page.screenshot({path:evidenceDir+'/orders-empty-phone.png',fullPage:true});
 ...
 await page.screenshot({path:evidenceDir+'/orders-fictional-phone.png',fullPage:true});
 ...
 await page.screenshot({path:evidenceDir+'/orders-retry-phone.png',fullPage:true});
...
finally{writeFileSync(evidenceDir+'/orders-proof.json',JSON.stringify(evidence,null,2));await browser.close()}

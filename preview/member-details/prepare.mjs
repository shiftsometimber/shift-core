...
c.vars.STAGING_REVIEW_ACCOUNT_LIMIT='100'; // Finite human-review allowance; other staging hosts retain 20.
delete c.vars.MEMBER_ADDRESS_PROVIDER;delete c.vars.MEMBER_ADDRESS_API_KEY; // Manual address entry only.

...
const formPath=process.env.GP_FORM_TEST_PATH||'/__review/gp-form';assert(['/__review/gp-form','/__review/gp-form-alternate'].includes(formPath));
const dir='work/staging/generated/review-evidence'+(formPath.endsWith('-alternate')?'/gp-alternate':'');mkdirSync(dir,{recursive:true});
...
if(!formPath.endsWith('-alternate'))await import('./assurance-proof.mjs');

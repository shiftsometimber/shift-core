...
for(const [name,engine,viewport]of [['chromium-desktop',chromium,{width:1440,height:1000}],['chromium-phone',chromium,{width:390,height:844}],['webkit-desktop',webkit,{width:1440,height:1000}],['webkit-phone',webkit,{width:390,height:844}]]){
 ...
 try{
  ...
  assert.match(await page.locator('.op-lead').filter({hasText:'This is an option to compare.'}).innerText(),/may not match every format, access or budget/);assert.equal(await page.locator('.op-recommendation strong').innerText(),'THIS OPTION');

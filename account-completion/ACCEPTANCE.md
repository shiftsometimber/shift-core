...
## Residential postcode failure — release held

The owner-reported residential postcode returned no complete addresses through Photon. The replacement provider’s public live demo returned 68 selectable addresses on 23 September 2026. An Ideal Postcodes adapter and shared home/delivery UI are prepared behind explicit provider selection plus a server-side key. No signup, trial, purchase, provider activation or production release has been performed. Existing preview remains on the held Photon candidate until an owner-approved trial key is installed and the replacement is verified there. See `docs/decisions/2026-09-23-postcode-replacement.md`.

...
const files=['personal-platform-v1.js','member-commissioning-v1.js','knowledge-graph-v1.js','radar-integration-v1.js','radar-public-v1.js','radar-e2e-staging.mjs','shift-ai-v3.js','worker-entry-v6.js','auth-recovery-v1.js','wrangler.jsonc','migrations/002_personal_knowledge_radar.sql'];
let failed=false;
...
if(!wrangler.includes('"AUTH_EMAIL_FROM": "welcome@shiftsometimber.co.uk"')||!wrangler.includes('"PUBLIC_SITE_URL": "https://shiftsometimber.co.uk"')){console.error('Auth email sender/site configuration missing');failed=true}

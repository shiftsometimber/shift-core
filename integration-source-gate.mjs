...
const files=['personal-platform-v1.js','knowledge-graph-v1.js','radar-integration-v1.js','radar-public-v1.js','radar-e2e-staging.mjs','shift-ai-v3.js','worker-entry-v6.js','migrations/002_personal_knowledge_radar.sql'];
let failed=false;

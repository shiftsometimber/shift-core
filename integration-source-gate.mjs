...
const files=['personal-platform-v1.js','knowledge-graph-v1.js','radar-integration-v1.js','shift-ai-v3.js','worker-entry-v6.js','migrations/002_personal_knowledge_radar.sql'];
let failed=false;
...
if(!entry.includes('personalRoutes')||!entry.includes('knowledgeRoutes')||!entry.includes('radarRoutes')||!entry.includes('runRadarFreshness')){console.error('Production entry point is not fully wired');failed=true}

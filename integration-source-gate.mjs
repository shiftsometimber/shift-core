...
const files=['personal-platform-v1.js','member-commissioning-v1.js','knowledge-graph-v1.js','radar-integration-v1.js','radar-public-v1.js','radar-e2e-staging.mjs','radar-scheduled-scan-v1.js','radar-scheduled-scan-staging.mjs','shift-ai-v3.js','worker-entry-v6.js','auth-recovery-v1.js','wrangler.jsonc','migrations/002_personal_knowledge_radar.sql'];
let failed=false;
...
if(!radarScheduled.includes("'scan'")||!radarScheduled.includes("'scheduler'")||!radarScheduled.includes('runRadarFreshness')){console.error('Scheduled Radar scan heartbeat is not wired');failed=true}

...
<h2 data-section="06" id="media">Media and reuse</h2><p>You may reproduce the derived findings with attribution and a link to this page. Cite NHS England as the primary data source. For data questions or founder comment, email <a href="mailto:press@shiftsometimber.co.uk"><strong>press@shiftsometimber.co.uk</strong></a>.</p>`;

...
const EDITORIAL_TICKER_BASELINE=[
 {id:'editorial-wegovy-tablet-uk',headline:'Wegovy tablet approved in the UK: what the new needle-free route means',story_headline:'Wegovy tablet approved in the UK',source_published_at:'2026-06-11',published_at:'2026-09-09',url:'/weight-loss-tablets-for-men'},
 {id:'editorial-medicine-news',headline:'Approved medicine news and practical context',story_headline:'SHIFT AI Newsroom',source_published_at:null,published_at:null,url:'/medicine-news'},
 {id:'editorial-clinic-quiet',headline:'When the clinic goes quiet, Shift stays on',story_headline:'When Your Mounjaro Clinic Goes Quiet',source_published_at:null,published_at:null,url:'/articles/stopping-glp1'},
 {id:'editorial-treatment-routes',headline:'Compare treatment routes and honest availability',story_headline:'Treatment routes and availability',source_published_at:null,published_at:null,url:'/treatment-centre'},
];
...
export async function radarPublicRoutes(request,env){
 ...
 if(path==='/v1/radar/ticker'){
  ...
  const servingLive=Boolean(freshness.current&&items.length),servedItems=servingLive?items:EDITORIAL_TICKER_BASELINE;
  return json({ok:true,current:servingLive,status:servingLive?freshness.status:'DEGRADED',serving:servingLive?'approved_live_wire':'approved_editorial_baseline',freshness,message:servingLive?null:'Approved evergreen links are serving while the governed newsroom queue awaits its first publication.',items:servedItems});
 }

...
need(/clearLegacyHostCookie\(response,request\);response\.headers\.append\('Set-Cookie',sessionCookie/.test(login),'shared cross-subdomain session cookie is not appended after legacy-cookie cleanup');

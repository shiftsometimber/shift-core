...
/* Own both colours: the retained recovery stylesheet gives every article a
   cream background. Inherited cream text alone made these records invisible.
   Scope this correction to Passport records, not the rest of My Timber. */
.hp-v1 article.hp-record{background:#050505;color:#E7E3DA}
.hp-v1 article.hp-record :is(h4,p,details,summary,strong,small,span){color:#E7E3DA;-webkit-text-fill-color:#E7E3DA}
.hp-v1 article.hp-record .hp-actions :is(button,a){background:#E7E3DA;color:#050505;-webkit-text-fill-color:#050505}

...
export const draft=()=>({version:1,id:crypto.randomUUID(),createdAt:new Date().toISOString(),expiresAt:new Date(Date.now()+1800000).toISOString(),answers:{why:['Lose weight','Feel more energy'],med:['No medication'],access:['NHS'],budget:['£0 / NHS']}});

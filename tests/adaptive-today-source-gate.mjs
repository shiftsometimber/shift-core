...
for(const marker of ['Life changed?','Sort my next three hours','Guts playing up','Going to the pub','DO THIS NOW','NEXT · FOOD','LATER · MOVEMENT','Rebuilding what remains…','food','movement','fluids'])assert.ok(client.includes(marker),`missing adaptive day marker ${marker}`);

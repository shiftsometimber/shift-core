...
for(const marker of ['Life changed?','Sort my next three hours','Guts playing up','Going to the pub','ONE USEFUL THING','NEXT · FOOD','LATER · MOVEMENT','Hang on…','sorting food…','shortening movement…','adjusting water…'])assert.ok(client.includes(marker),`missing adaptive day marker ${marker}`);

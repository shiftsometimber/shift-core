...
assert.match(adapter,/mhra_adapter_redirect_rejected/);
...
assert.match(module,/R1\.4-MHRA-NAION-2026-02-05-V1/);
assert.match(module,/specialist_review_packet/);
assert.match(module,/page_baseline_and_rollback_capture/);
assert.match(module,/publication_authority_disabled/);
assert.match(module,/capabilities:\{attachCopy:false,qualifiedApproval:false,communicationsApproval:false,publish:false,rollback:false,newsletter:false,social:false,model:false\}/);

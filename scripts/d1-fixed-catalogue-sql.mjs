...
const sql=["SELECT CASE WHEN (SELECT COUNT(*) FROM structured_content WHERE content_type IN ('recipe','exercise')) IN (2124,5551) THEN 1 ELSE json('catalogue_snapshot_count_drift') END;"];

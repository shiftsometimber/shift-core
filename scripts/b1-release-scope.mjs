...
export function validateScope(manifest,changed){
 ...
 assert.equal(manifest.applicationCommit,'ea17f0a66370aa976f4060b8cb1f1bd83239ff68');
 assert.equal(manifest.baseCommit,'1339233cf0b29c79a3a4c291774eabaca6a84973');

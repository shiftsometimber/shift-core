...
export function validateScope(manifest,changed){
 ...
 assert.equal(manifest.applicationCommit,'62936c4b55fd512fcae794c9fec27f7f3344b049');
 assert.equal(manifest.baseCommit,'d61ff3f21e264377ec97f5a2bd4bed04daf64aff');

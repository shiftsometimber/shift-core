...
export function validateScope(manifest,changed){
 ...
 assert.equal(manifest.applicationCommit,'76cedf6a19be30e5205893fd633e90423a7fa657');
 assert.equal(manifest.baseCommit,'2d5931d9250f66c5196cf3629f52687dce6bdbb6');

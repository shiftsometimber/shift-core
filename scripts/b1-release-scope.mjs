...
export function validateScope(manifest,changed){
 ...
 assert.equal(manifest.applicationCommit,'1cda701a7eb2b5a9aa70c28b32bd5070c258e428');
 assert.equal(manifest.baseCommit,'1af0b7bb9e2d354198bcee918cbbd2da2b11b7fc');

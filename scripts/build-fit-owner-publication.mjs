...
import {buildFitOwnerRelease,fitDigest} from '../fit-expansion-publication-v1.mjs';
import {catalogueRowsSha256} from '../catalogue-publication-shared.mjs';
const read=p=>JSON.parse(fs.readFileSync(p));
const root='evidence/fit-publication-2026-09-16';
const candidate=read(`${root}/resolved-candidate.json`),owner=read('evidence/owner-publication-instruction-2026-09-16.json');

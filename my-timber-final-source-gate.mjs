...
for(const marker of ['390,height:844','recordVideo','working_late','choose-today','dailyAfter.connected?.meal?.recipeId','chosenWorkspace','.mtm-announcement','data-fit-today-handoff','savedFitBefore.plan','savedFitAfter.plan','horizontal overflow'])need(production.includes(marker),`missing genuine production walkthrough assertion: ${marker}`);

...
let vaguePortions=0,countOnlyEggs=0,unmeasurableV3Bases=0;
...
console.log(JSON.stringify({proof:'INDUSTRIAL_RECIPE_EXACT_QUANTITY_QUALITY',recipes:recipes.length,vaguePortions,countOnlyEggs,unmeasurableV3Bases,repairedPortionAmounts:c.metrics.repairedPortionAmounts,repairedEggAmounts:c.metrics.repairedEggAmounts},null,2));
console.log('PASS industrial recipe exact-quantity quality: generated bases and eggs use explicit measurable quantities rather than vague serving placeholders.');

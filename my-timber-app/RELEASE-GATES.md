...
| Privacy/account deletion | Inventory includes remotely loaded code, cookies, analytics and health data; accurate store disclosures; working in-app deletion initiation and external deletion URL; owner/regulatory review as applicable | Existing authenticated Settings deletion flow documented; public `/account-deletion` and `/my-timber/privacy` deployed and live-verified 23 Sep 2026; signed-device in-app verification still OPEN |

...
|---|---|---|
| Owner-controlled store accounts | Apple and Google organisation verification, assigned secure roles; app/package name availability | Not verified; no purchases made |
| Signing and identities | Team ID, bundle ID, Android Play signing; no secrets in repository/chat | Not configured |
...
| Privacy/account deletion | Inventory includes remotely loaded code, cookies, analytics and health data; accurate store disclosures; working in-app deletion initiation and external deletion URL; owner/regulatory review as applicable | Not audited; no completed privacy claims manufactured |

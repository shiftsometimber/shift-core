...
|---|---|---|
| Owner-controlled store accounts | Apple and Google organisation verification, assigned secure roles; app/package name availability | D-U-N-S confirmed available by owner 23 Sep 2026; Apple/Google organisation accounts still not verified; no purchases made |

...
try{
  ...
  await page.locator('select[name="medicine"]').selectOption({index:1});await page.locator('select[name="strength"]').selectOption({index:1});await page.locator('select[name="lastDoseTiming"]').selectOption('0_7');await page.getByRole('button',{name:/Show my routes/}).click();await page.getByRole('heading',{name:/Your answers point here/}).waitFor();await pause(page);await screen(page,'03-catalogue-results');await zeroOverflow(page,'Route results');await compactPage(page,'Route results',3800);
  ...
  await page.getByRole('link',{name:/Understand this route/}).first().click();await page.locator('h1.tp-title').waitFor();await pause(page);await screen(page,'04-product-information');await zeroOverflow(page,'Product information');await compactPage(page,'Product information',5000);

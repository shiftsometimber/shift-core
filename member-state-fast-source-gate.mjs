...
need(/!\['\/v1\/member-state','\/v1\/profile'\]\.includes\(path\)\|\|!\['GET','PATCH'\]\.includes\(request\.method\)/.test(source),'route is not restricted to exact member-state/profile GET/PATCH requests');

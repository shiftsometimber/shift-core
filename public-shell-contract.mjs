  ...
  "/weight-loss-injections-for-men": [
    {
      ...
      "links": [
        ...
        {
          "path": "/compare-weight-loss-treatments",
...
export function reconcilePublicDocument(html,path){
 ...
 if(path==='/member-login'&&!/<script\b[^>]*\bsrc=["']\/api-adapter-v33d\.js(?:\?[^"']*)?["'][^>]*>/i.test(html)){

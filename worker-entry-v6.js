...
const GIT_MEMBER_ASSETS=new Map([
  ...
  ['/my-timber-global-header-v1.css','text/css; charset=utf-8'],
  ['/my-timber-global-header-v1.js','application/javascript; charset=utf-8'],
  ...
  ['/assets/sst-logo-official.png','image/png'],

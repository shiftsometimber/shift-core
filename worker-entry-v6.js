...
async function withCosTickerLock(response, request) {
  ...
  headers.delete("Last-Modified");
  headers.set("Cache-Control", "no-store, must-revalidate");
  headers.set("X-Shift-Ticker-Authority", "cos-worker-v1");

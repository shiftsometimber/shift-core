...
Week one means days 1–7 after registration, with eight complete days required. Week four means days 21–27 with 28 complete days required. Week eight means days 49–55 after registration, with 56 complete days required. Request `GET /v1/hq/journey?days=90` (authenticated HQ access) to include mature week-eight accounts; the existing default 30-day cohort cannot contain them. An immature or absent eligible cohort returns a null rate, never a fabricated zero. Returns are observed authenticated logins or successful Journey/Passport writes, not all passive visits. First save is not a health outcome. Missing historical audit entries and erased accounts can reduce observed counts. Unknown staff/test activity can remain; no claim of perfect internal-traffic exclusion.

...
function detailMain(row){
 ...
 const meaningHtml=content.shift_take?'<section data-shift-take><h2>SHIFT’s take</h2><p class="radar-news-meta">SHIFT’s interpretation of the findings and what they could mean for members.</p><p>'+esc(meaning)+'</p></section>':meaningInBody?'':'<section><h2>What this means in the UK</h2><p>'+esc(meaning||'Check the cited evidence and current UK guidance.')+'</p></section>';
...
function detailHead(html,row,request){
 ...
 const image=String(seo.image||"/assets/og-default.jpg"),absoluteImage=image.startsWith("http")?image:"https://shiftsometimber.co.uk/"+image.replace(/^\//,""),schema={"@context":"https://schema.org","@type":"Article",headline:title,description,image:[absoluteImage],datePublished:publishedAt(row),dateModified:seo.dateModified||row.updated_at||publishedAt(row),author:{"@type":"Organization",name:seo.author||"SHIFT Newsroom"},publisher:{"@type":"Organization",name:"Shift Some Timber",logo:{"@type":"ImageObject",url:"https://shiftsometimber.co.uk/assets/shift-wordmark.png"}},mainEntityOfPage:canonical.href};

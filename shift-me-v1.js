...
function renderDirectives(data){
  const maps={
    ...
    top:{'Black tee':'black short-sleeve crew-neck tee with a small high-contrast Shift Some Timber S-in-a-circle mark on the left chest','Olive tee':'olive short-sleeve crew-neck tee with a small cream Shift Some Timber S-in-a-circle mark on the left chest','White tee':'cream short-sleeve crew-neck tee with a small black Shift Some Timber S-in-a-circle mark on the left chest','Grey marl vest':'grey marl sleeveless vest with a small black Shift Some Timber S-in-a-circle mark on the left chest','Black polo':'black short-sleeve polo shirt with a small cream Shift Some Timber S-in-a-circle mark on the left chest','Black hoodie':'black pullover hoodie with a small cream Shift Some Timber S-in-a-circle mark on the left chest','Olive hoodie':'olive pullover hoodie with a small cream Shift Some Timber S-in-a-circle mark on the left chest','Black quarter zip':'black long-sleeve quarter-zip top with a small cream Shift Some Timber S-in-a-circle mark on the left chest'},

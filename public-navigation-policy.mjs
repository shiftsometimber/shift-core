...
#shift-public-news{box-sizing:border-box;display:grid!important;grid-template-columns:auto minmax(0,1fr);align-items:center;gap:16px;width:100%;max-width:100%;overflow:hidden;background:#050505;color:#E7E3DA;border-block:1px solid #707762;padding:10px max(18px,4vw);font:700 14px/1.45 Arial,sans-serif}
#shift-public-news a{color:#E7E3DA;-webkit-text-fill-color:#E7E3DA;text-decoration:none}#shift-public-news a:hover,#shift-public-news a:focus-visible{text-decoration:underline}#shift-public-news a:focus-visible{outline:2px solid #E7E3DA;outline-offset:3px}

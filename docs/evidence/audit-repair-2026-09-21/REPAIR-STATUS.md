...
Production promotion and post-release acceptance require a separate release decision. Current Pages deployment/source mapping must be established; the preview's pinned Pages baseline alone is insufficient. Mail delivery, physical-device checks, Radar source health and the full operational acceptance gaps remain as recorded in the audit. Payment/question sequencing and named clinical/pharmacy hand-offs are unresolved operating decisions.

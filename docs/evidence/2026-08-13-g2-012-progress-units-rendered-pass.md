...
G2-012 moves AMBER -> PASS. Original-audit accounting therefore moves from `29 PASS / 25 AMBER / 3 BLOCKED` to `30 PASS / 24 AMBER / 3 BLOCKED`. Any Category-A board that currently counts G2-012 as an open Category-A blocker falls by one at the same reconciliation point.

...
| Newsroom | [PR #688](https://github.com/shiftsometimber/shift-core/pull/688) remains separate; its existing preview had 24 sources, 21 retrievals, three failures and zero publications. The public newsroom responds, but unseen HQ drafts and their SEO/approval status have not been verified. | Source/discovery repair has 41 passing tests against current main. A separate correction is being prepared for an older fault that could overwrite a reviewed article’s source evidence under its existing approval. Preserve reviewed snapshots and require explicit correction review. Review each actual draft and its SEO/evidence through named HQ access; do not bulk manufacture approval. |

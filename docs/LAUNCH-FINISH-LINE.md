...
| B08 | Dave release-candidate journey | AMBER — G1-012 unattended synthetic Dave release coverage is PASS and genuine registration/verification/logout-return is now production-proven. Remaining Dave boundary is real account recovery, final genuine-device acceptance and partner-dependent treatment support. |

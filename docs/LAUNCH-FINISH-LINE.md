...
| M11 | Grub catalogue depth, validated nutrition and variety | AMBER — **2,908 authored / 2,876 industrial**; **2,876/2,876** ingredient-level CoFID nutrition/risk valid with zero nutrition quarantine. Pre-review defects in the old 783 pack were repaired before Matt review. The current launch authority is **798 clean recipes behind exactly 8 regenerated immutable decisions**; breakfast 212 / lunch 204 / dinner 195 / snack 187, zero exact repeats through 30/60/90 days under the commissioned simulation. The decision -> publication bridge binds dynamically to the regenerated manifest: all 8 PASS yields exactly 798 reviewed+validated records; any FIX/REJECT emits no partial payload. Review run `31803717241`, artifact `9220287723`. Remaining closure is genuine finite review -> publication -> production-serving proof. |
| M12 | Fit catalogue/session breadth and visual guidance | AMBER — **2,500 authored**; finite V1 launch cohort **26 canonical movement decisions / 1,326 technically eligible descendants** with 180/180 unique prescribed objects across the 12-week simulation. Pre-review commissioning removed generic START/MOVE/FINISH captions from 16 candidates and added a fail-closed placeholder regression gate. Fresh pack is **26/26 produced and 26/26 technically QA-passed** from movement-specific render contracts; genuine anatomy/member-comprehension/domain acceptance remains 0/26. Review run `31802631318`, artifact `9219877222`. |
...
Exactly **57** original rows remain mandatory. Current evidenced classification is **50 PASS / 4 AMBER / 3 BLOCKED / 0 abstraction orphans**. The latest earned promotions are **G1-001 password recovery** and **G5-013 Dave non-clinical end-to-end commissioning**, proved through the genuine connected inbox and retained credential lifecycle. Evidence: `docs/evidence/2026-08-14-g1-001-real-password-recovery-pass.md`.

## Content conversion funnel
**Grub:** structured authored universe **2,908** = 2,876 industrial + 32 existing structured. Industrial schema-valid **2,876** and **2,876/2,876** ingredient-level CoFID nutrition-valid with zero nutrition quarantine. The V1 launch conversion is the repaired **798-recipe** cohort behind **8 regenerated immutable editorial decisions**; the decision-to-publication bridge is technically ready and fails closed on any non-PASS decision. Genuine second-person decisions still govern publication.

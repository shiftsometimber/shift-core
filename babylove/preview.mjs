...
const config={name:'shift-babylove-preview',main:'../../worker-entry-v6.js',compatibility_date:'2026-08-09',compatibility_flags:['nodejs_compat'],workers_dev:true,preview_urls:false,vars:{BABYLOVE_WEBHOOK_TOKEN_SHA256:createHash('sha256').update(token).digest('hex')},d1_databases:[{binding:'DB',database_name:name,database_id:id}]};

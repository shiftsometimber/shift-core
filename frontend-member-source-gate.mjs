...
need(/P0_HREF='\/member-p0-v1\.css\?v=6'/.test(shell),'member shell does not inject current versioned P0 CSS');
...
need(/GIT_MEMBER_JS_ASSETS=new Set\(\['\/api-adapter-v33d\.js','\/member-product-v33d\.js','\/member-shell-v33g\.js','\/member-progress-v1\.js','\/member-progress-picture-premium-v1\.js'\]\)/.test(workerEntry),'Worker does not explicitly serve all commissioned Git-authoritative member JS assets');
...
for(const asset of ['member-product-v33d.js','member-shell-v33g.js','member-progress-v1.js','member-progress-picture-premium-v1.js']){

...
for(const marker of ['getDailyShift','adjustDailyShift','saveDailyMeal','saveDailyShiftAction','I’ll have that','Swap it','Don’t suggest again','data-adjust','data-water','data-next-action','revealRoot'])need(ui.includes(marker),`real Today action missing: ${marker}`);

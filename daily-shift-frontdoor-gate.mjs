...
for(const marker of ['getDailyShift','adjustDailyShift','saveDailyMeal','I’ll have that','Swap it','Don’t suggest again','data-adjust','data-water'])need(ui.includes(marker),`real Today action missing: ${marker}`);

...
const checks=[
 ...
 ['transient model failures receive one bounded retry',route.includes('async function runImageModel')&&route.includes('attempt<2')&&route.includes('setTimeout(resolve,300)')],

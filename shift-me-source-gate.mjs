...
const checks=[
 ...
 ['live dashboard loads complete Shift Me dependency chain',dashboard.includes('href="/shift-me-api-v1.js?v=1"')&&dashboard.includes('href="/member-shift-me-premium-v1.css?v=2"')&&dashboard.includes('src="/shift-me-api-v1.js?v=1"')&&dashboard.includes('src="/member-shift-me-premium-v1.js?v=2"')],

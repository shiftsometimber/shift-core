...
const checks=[
 ...
 ['generated references stay within FLUX rerender dimensions',route.includes('const OUTPUT_SIZE=480')&&route.includes("modelForm.append('width',String(OUTPUT_SIZE))")&&route.includes('dimensions.width>=512||dimensions.height>=512')],
 ['member source photos are reduced for the FLUX reference contract',browser.includes('async function modelReadyImage')&&browser.includes('limit=480')],

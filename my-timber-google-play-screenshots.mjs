...
async function shot(i,slug,label){await cookie();await page.evaluate(()=>scrollTo(0,0));await page.waitForTimeout(250);const file=String(i).padStart(2,'0')+'-'+slug+'.png';await page.screenshot({path:path.join(dir,file),fullPage:false});screens.push({file,label,width:780,height:1386});}

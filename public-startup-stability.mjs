...
export const programmeBridge='<aside class="sst-service-bridge" aria-labelledby="sst-service-bridge-title"><div class="sst-service-bridge__main"><p class="sst-service-bridge__kicker">What Shift does</p><h2 id="sst-service-bridge-title">Turn useful information into a weight-management plan.</h2><p class="sst-service-bridge__intro">Shift helps men understand their weight, choose a realistic route and build a personalised programme around food, movement, sleep, progress and support—with access to clinically assessed treatment where appropriate.</p><div class="sst-service-bridge__limits"><div class="sst-service-bridge__limit"><strong>What we can do</strong><span>Explain your options and help you plan food, movement, sleep and check-ins.</span></div><div class="sst-service-bridge__limit"><strong>What we can’t do</strong><span>Guarantee medication, replace your GP or provide treatment without clinical assessment.</span></div></div></div><div class="sst-service-bridge__action"><p>Ready to make it personal? Three quick questions. One useful starting point.</p><a class="sst-service-bridge__cta" href="/start-here?from=programme">Start my Shift &rarr;</a></div></aside>';

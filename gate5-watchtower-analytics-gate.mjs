...
for(const marker of ['member_errors','knowledge_stale','workersAiBound','emailBound','readRadarFreshness','attention'])if(!watch.includes(marker))fail(`Watchtower missing ${marker}`);
...
if(failed)process.exit(1);console.log('GATE 5 WATCHTOWER/ANALYTICS PASS — operational snapshot, canonical freshness, event taxonomy, core server instrumentation and internal outcome cohort are regression-protected.');

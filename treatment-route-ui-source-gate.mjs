...
const checks={
  ...
  immediateResult:/state\.step==='result'/.test(js)&&/These routes fit your preference/.test(js),
  ...
  ,productFailClosed:/Treatment access closed/.test(product)&&/Treatment access closed/.test(options)&&/nothing can be purchased yet/.test(options)

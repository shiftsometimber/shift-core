...
export const dayGuideRuntime=String.raw`(()=>{
 ...
 function render(){
  ...
  host.replaceChildren();const kicker=document.createElement('p');kicker.textContent='YOU ARE HERE · TODAY';const details=document.createElement('details');details.open=!collapsed;const title=document.createElement('summary');title.textContent='Start here today';details.append(title);const intro=document.createElement('p');intro.textContent='One useful day, at your pace. These are options, not targets. Skip what does not fit; rest when you need it.';details.append(intro);const list=document.createElement('ol');const current=steps.findIndex(s=>!s[3]);

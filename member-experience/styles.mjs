...
.sst-member-experience :is(#grubSearchGo,#grubGenerate,#grubWeekGenerate,#grubPrint,.grub-spotlight button,.grub-actions button,#sgAddIngredient,#shoppingForm button,.sf-build,.sf-start,.sf-review-save,#saveMood,.mj-next button,.mj-setup button[type=submit],.mj-weekly button){background:#25351e!important;color:#fff!important;border:1px solid #25351e!important;border-radius:8px!important;padding:13px 18px!important;font-size:15px!important;box-shadow:none!important}
.sst-member-experience :is(#grubSearchGo,#grubGenerate,#grubWeekGenerate,#grubPrint,.grub-spotlight button,.grub-actions button,.sf-build,#saveMood,.mj-next button):hover{background:#3e5434!important;color:#fff!important}
...
/* The legacy phone stylesheet hides .sf-exercise-art below 620px. Keep the
   approved guide visible at every width and give it a full row in the card. */
html body.sst-member-experience[data-member-page="fit"] .sf-exercise{grid-template-columns:minmax(0,1fr) auto!important;align-items:start!important;gap:14px!important}
html body.sst-member-experience[data-member-page="fit"] .sf-exercise>.sf-number{grid-column:1!important;grid-row:1!important;justify-self:start}
html body.sst-member-experience[data-member-page="fit"] .sf-exercise>.sf-exercise-actions{grid-column:2!important;grid-row:1!important;margin:0!important;justify-self:end}
html body.sst-member-experience[data-member-page="fit"] .sf-exercise>.sf-exercise-art{display:block!important;visibility:visible!important;grid-column:1/-1!important;grid-row:2!important;width:100%!important;max-width:720px!important;justify-self:center}
html body.sst-member-experience[data-member-page="fit"] .sf-exercise>.sf-exercise-main{grid-column:1/-1!important;grid-row:3!important;width:100%!important}
.sst-member-experience .sf-difficulty{display:grid;gap:10px;margin:18px 0;padding:16px;background:#e4e8da;border:1px solid #aeb89c;border-radius:10px}.sst-member-experience .sf-difficulty>strong{font-size:12px!important;letter-spacing:.08em}.sst-member-experience .sf-difficulty-options{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:8px}.sst-member-experience .sf-difficulty-options button{min-height:46px;padding:9px 10px;border:1px solid #707762;border-radius:8px;background:#f4f1e9;color:#11140f;font:700 14px/1.2 Arial,sans-serif}.sst-member-experience .sf-difficulty-options button:is(.active,:hover,:focus-visible){background:#25351e;color:#fff;border-color:#25351e}.sst-member-experience .sf-difficulty p{margin:0!important;color:#30352c!important;font-size:14px!important}.sst-member-experience .sf-exercise-purpose{display:grid;gap:12px;margin:16px 0;padding:14px;background:#eef0e8;border-left:4px solid #55704a;border-radius:0 8px 8px 0}.sst-member-experience .sf-exercise-purpose>div{display:grid;gap:3px}.sst-member-experience .sf-exercise-purpose small{font-size:10px!important;font-weight:800;letter-spacing:.11em;color:#4c5245!important}.sst-member-experience .sf-exercise-purpose strong{font-size:15px!important}.sst-member-experience .sf-exercise-purpose p{margin:0!important;font-size:14px!important;line-height:1.45!important}.sst-member-experience .sf-exercise-purpose details{margin-top:2px}.sst-member-experience .sf-exercise-purpose ul{margin:8px 0 0;padding-left:18px}.sst-member-experience .sf-exercise-purpose a{color:#25351e!important;text-decoration:underline;text-underline-offset:3px}@media(max-width:440px){.sst-member-experience .sf-difficulty-options{grid-template-columns:1fr}.sst-member-experience .sf-difficulty-options button{width:100%}}
...
export const journeyStyles=String.raw`.mt-connected-life{display:flex;align-items:center;justify-content:space-between;gap:24px;padding:26px;border:1px solid #707762;border-radius:12px;background:#10160f;color:#e7e3da;margin:22px 0}.mt-connected-life h3{font-size:38px;margin:12px 0}.mt-connected-life p{font-size:16px;color:#c9cebf}.mt-connected-life a{color:#e7e3da}.member-journey-handoff{padding:24px;border:1px solid #707762;border-radius:12px;margin:24px 0;background:#10160f;color:#e7e3da}.member-journey-handoff a{color:#e7e3da}.mt-linked-note{font-size:14px}.mt-today-top>.mt-button{display:inline-block;min-height:44px}@media(max-width:640px){.mt-connected-life{display:block}.mt-connected-life .mt-button{margin-top:14px;display:inline-block}}`;

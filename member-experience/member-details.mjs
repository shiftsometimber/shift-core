import {photonSearchMarkup,photonAddressRuntime} from './photon-address-client.mjs';
  ...
  <form id="memberDetailsForm">
   <fieldset id="memberDetailsFields" disabled><legend class="md-sr">Your personal and contact details</legend>
    ...
    <div class="md-section"><h3>Home address</h3><div class="md-postcode">
     <label for="memberPostcode">Postcode<input id="memberPostcode" name="postcode" autocomplete="postal-code" maxlength="12" aria-describedby="memberAddressHelp"></label><button id="memberFindAddress" type="button" class="md-secondary">Search address suggestions</button>
    </div>
    ${photonSearchMarkup('member')}
...
// Both address forms use the shared Photon component below.
...
load();
})();`+deliveryRuntime+emailChangeRuntime+photonAddressRuntime;

...
const brain=read('shift-brain-v1.js'),ai=read('shift-ai-v6.js'),safety=read('shift-ai-v7.js'),entry=read('worker-entry-v6.js'),daily=read('member-daily-v3.js'),product=read('member-product-v6.js'),experience=read('member-experience-v2.js'),gateway=read('shift-ai.js');
...
console.log('ONE SHIFT BRAIN GATE PASS — canonical member context, unified reviewed knowledge, AI, clinical boundary, Today, Grub/Fit and proactive consumers are wired through one contract.');

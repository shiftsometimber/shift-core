...
const brain=read('shift-brain-v1.js'),ai=read('shift-ai-v6.js'),safety=read('shift-ai-v7.js'),entry=read('worker-entry-v6.js'),daily=read('member-daily-v3.js'),product=read('member-product-v6.js'),structuredProduct=read('member-product-v7.js'),durationProduct=read('member-product-v8.js'),experience=read('member-experience-v2.js'),gateway=read('shift-ai.js');
...
if(!durationProduct.includes("memberProductV7Routes"))fail('V8 duration layer must preserve V7 structured product authority and therefore V6 One Shift Brain behaviour');else ok('V8 duration layer preserves V7/V6 One Shift Brain behaviour');
...
console.log('ONE SHIFT BRAIN GATE PASS — canonical member context, unified reviewed knowledge, AI, clinical boundary, Today, V8/V7 Grub/Fit structured runtime and proactive consumers are wired through one contract.');

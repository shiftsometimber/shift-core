...
(function(){
  ...
  window.SST_SHIFT_ME={renderShiftMe,rerenderShiftMe,getShiftMe,deleteShiftMe,shiftMeImageUrl};
  if(window.SST_API){Object.assign(window.SST_API,{renderShiftMe,rerenderShiftMe,getShiftMe,deleteShiftMe,shiftMeImageUrl});}
})();

...
function renderObject(obj){
 ...
 if(obj.mode==='fridge_freezer_cupboard'||obj.mode==='use_what_you_have'||Array.isArray(obj.top))return renderConundrum(obj);

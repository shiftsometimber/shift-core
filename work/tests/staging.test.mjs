...
await test('Bundled workplace browser asset starts and renders without Worker-only helpers',async()=>{
 ...
 const fetch=async(url)=>{requests.push(url);return {status:200,ok:true,json:async()=>({workplaces:[]})}};
 new Function('document','fetch','addEventListener','AbortController','DOMException',source)(document,fetch,()=>{},AbortController,DOMException);

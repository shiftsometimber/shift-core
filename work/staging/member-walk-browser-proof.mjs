...
const report={at:new Date().toISOString(),commit:process.env.GITHUB_SHA,cases:[],failures:[],limits:['Fictional isolated accounts only','Session latency and a503 are deliberately injected for recovery checks; successful session and day adjustment use real APIs','No password reset email or real member writes']};

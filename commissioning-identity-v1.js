...
const SYNTHETIC=/^shiftsometimber\+(?:finish|longitudinal|b03|structured|structured-authrender|sport)-[a-z0-9-]+@gmail\.com$/i;
const ALLOWED_WORKFLOWS=['/.github/workflows/master-integration-gate.yml@','/.github/workflows/production-commissioning.yml@','/.github/workflows/my-timber-final-production.yml@','/.github/workflows/gate1-rendered-browser.yml@','/.github/workflows/dave-release-gate.yml@','/.github/workflows/g2-011-progress-production.yml@','/.github/workflows/g2-013-progress-picture-production.yml@','/.github/workflows/g2-014-progress-picture-premium.yml@','/.github/workflows/g2-015-plan-manager.yml@','/.github/workflows/g1-real-password-recovery.yml@','/.github/workflows/shift-me-gate.yml@','/.github/workflows/final-v1-production-publication.yml@','/.github/workflows/sport-fit-production.yml@','/.github/workflows/shift-ai-r4-production-pilot.yml@'];

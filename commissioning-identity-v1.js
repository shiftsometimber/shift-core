...
const ALLOWED_WORKFLOWS=['/.github/workflows/hq-controls-production-closeout.yml@','/.github/workflows/synthetic-production-safety-drills.yml@','/.github/workflows/master-integration-gate.yml@','/.github/workflows/production-commissioning.yml@','/.github/workflows/my-timber-final-production.yml@','/.github/workflows/gate1-rendered-browser.yml@','/.github/workflows/dave-release-gate.yml@','/.github/workflows/g2-011-progress-production.yml@','/.github/workflows/g2-012-progress-units.yml@','/.github/workflows/g2-013-progress-picture-production.yml@','/.github/workflows/g2-014-progress-picture-premium.yml@','/.github/workflows/g2-015-plan-manager.yml@','/.github/workflows/rendered-member-production-acceptance.yml@','/.github/workflows/g1-real-password-recovery.yml@','/.github/workflows/shift-me-gate.yml@','/.github/workflows/final-v1-production-publication.yml@','/.github/workflows/sport-fit-production.yml@'];

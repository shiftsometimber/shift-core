...
export function rewriteArticle(html,path){
 ...
 const schema={'@context':'https://schema.org','@graph':[{'@type':'Article','@id':canonical+'#article',headline:a.title,description:a.description,mainEntityOfPage:canonical,url:canonical,inLanguage:'en-GB',dateModified:UPDATED,...(published?{datePublished:published}:{}),author:{'@type':'Organization',name:'SHIFT Newsroom'},publisher:{'@type':'Organization',name:'Shift Some Timber Ltd',url:ORIGIN},citation:a.sources.map(x=>x.url)},{'@type':'BreadcrumbList',itemListElement:[{'@type':'ListItem',position:1,name:'Home',item:ORIGIN+'/'},{'@type':'ListItem',position:2,name:a.title,item:canonical}]}]};
